...
- But the core of us is a planning(time management) system rooted in GTD. With this system, you can achieve GTD easily and totally.  

## How GTD works-En
- About this topic, you can go to [Wikipedia](https://en.wikipedia.org/wiki/Getting_Things_Done). I will only make some simple introduction here.
- The core of GTD：
  - GTD's core thinks that only when you arrange everything well, you can focus on what you going to do and improve your effectiveness.
  ...
  - And, David Allen thinks, the stress is not from the task itself, but the messes caused by the tasks remain in your brain.
  - The things we have to do is to list the tasks in our brain into a file system which out of your brain, such as a real notebook, e-mail, etc. Then, you can focus on what you have to do now. 
- The operation methods of GTD：
  - **COLLECT**
    - It is to list all the unfinished things(called stuff) and put them into an inbox.
    - Inbox can be anything that can record, but it does not recommend you use a temporary thing.
  - **CLASSIFY**
    - After you put those(stuff) into the inbox, you need to sort them out regularly.
    - Then you should classify these stuff according to "can take action" and "can't take action"
    - To those stuff in "can't take action", you need to further classify them. Such as "data", "someday/future" and "trash".
    - And to those stuff in "can take action", you need to classify them according to can it be finished in two minutes. If can, you should take action right now. If not, you can plan the next action.
  - **ORGANIZE**
    - Organizations are mainly divided into "organization of data" and "organization of next actions"
    - "organization of data" is mainly a file management system.
    - And for "organization of next actions" can be divided into "next actions list" and "future/someday list".
    - And if an action connects to many actions, then you need to refine it into specific actions.
    - For example, if you are going to write a report about your hometown, that means you need to divide it into "Planning", "Picking", "Classify", "Make PowerPoint and document"...and some specific actions.
  ...
  - **REVIEW**
    ...
    - By reviewing and checking all your lists, and then updating them, to ensure the operation of the GTD system, and while reviewing, you may also need to plan for future actions (if you review once a week)
